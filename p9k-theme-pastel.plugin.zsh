...
() {
  ...
  # Work to ensure tty compatibility
  ...
  # Make PS2, 3, and 4 look pretty too.
  typeset -g PS2="%F{%(?.12.9)}%_$PASTEL_PROMPT_CHAR_INS%f "
  typeset -g PS3="%F{%(?.12.9)}$PASTEL_PROMPT_CHAR_INS%f "
  typeset -gx PS4="%F{12}%N:%i$PASTEL_PROMPT_CHAR_INS%f "
  ...
  #
  # Disable all default icons. We can add them if they feel needed.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION="$PASTEL_PROMPT_CHAR_INS$PASTEL_PROMPT_CHAR_INS"
  ...
  # The forground to be shown in unwritable dirs
  typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND=9
  ...
  POWERLEVEL9K_VCS_CONFLICTED_ICON=${(g::)POWERLEVEL9K_VCS_CONFLICTED_ICON}

  # Set our loading foreground for when gitstatus info is not available yet
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%41F'  # bright green foreground
      local     staged='%10F'  # green foreground
      local   modified='%11F'  # yellow foreground
      local  untracked='%9F'   # red foreground
      local conflicted='%134F' # purple foreground
    else
    ...
    # TODO: Look into icons for ahead / behind push remote
    ...
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${(g::)VCS_STATUS_ACTION}"  
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=41
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=064
  # Custom icon.
  ...
  ##################[ chezmoi_shell: chezmoi shell (https://www.chezmoi.io/) ]##################
  # chezmoi shell color.
  typeset -g POWERLEVEL9K_CHEZMOI_SHELL_FOREGROUND=14
  # Custom icon.
  typeset -g POWERLEVEL9K_CHEZMOI_SHELL_VISUAL_IDENTIFIER_EXPANSION='chezmoi'
  ...
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=41
