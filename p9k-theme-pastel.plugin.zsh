...
_pastel_config_vcs_p9k() {
    POWERLEVEL9K_VCS_UNTRACKED_ICON="%F{$__PASTEL_COLORS[red]}?%f"
    POWERLEVEL9K_VCS_UNSTAGED_ICON="%F{$__PASTEL_COLORS[yellow]}!%f"
    POWERLEVEL9K_VCS_STAGED_ICON="%F{$__PASTEL_COLORS[green]}+%f"
    POWERLEVEL9K_VCS_INCOMING_CHANGES_ICON="%F{$__PASTEL_COLORS[yellow]}>%f"
    POWERLEVEL9K_VCS_OUTGOING_CHANGES_ICON="%F{$__PASTEL_COLORS[yellow]}<%f"
    POWERLEVEL9K_VCS_STASH_ICON="%F{$__PASTEL_COLORS[yellow]}*%f"
}
